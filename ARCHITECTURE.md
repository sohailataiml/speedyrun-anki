...
- **Desktop** — Anki's existing Qt frontend, extended with the three-score dashboard. Main tool per the PRD.
- **Android** — fork AnkiDroid, which already embeds the Rust backend over JNI. Add the same dashboard. This is the phone companion.
